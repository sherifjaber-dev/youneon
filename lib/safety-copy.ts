...
Nobody from YouNeon will ask you to send Pi to a personal wallet, share a passphrase, or “verify” an account in a private chat. If they say they work here, they do not.`,
  ...
  {
    id: "detected",
    title: "What happens when inappropriate behavior is detected",
    body: `On some devices, YouNeon can run an on-device check of the incoming video. If it looks like sexual or other prohibited content, the remote picture blurs and you can Block and skip or briefly reveal the video. That check stays on your device; it is not a hidden recording.

You can also report at any time with the shield. Reports are stored for review. Repeat reports can remove the YouNeon Badge from that profile. We may not reply to every report, but we keep the evidence you chose to send.`,
  },
  {
    id: "minors",
...
export const COMMUNITY_GUIDELINES_SECTIONS = [
  ...
  },
  {
    ...
    body: `Do not show genitals, sexual acts, pornography, or masturbation on camera. Do not pressure anyone to undress, pose, or send sexual photos. “Just for a second” still counts. If the other person does not clearly want a sexual conversation, stop. YouNeon is for meeting people, not a porn studio.`,
  },
  {
    id: "minors-protect",
  ...
  {
    id: "hate",
    title: "4. No hate, insults, bullying, racism or threats",
  ...
  {
    id: "violence",
    title: "5. No violence, self-harm or disturbing content",
    body: `Do not show real-world violence, weapons used as a threat, graphic injury, or content that promotes self-harm or suicide. Do not dare someone to hurt themselves. If you are in crisis, contact local emergency services or a local crisis line — YouNeon is not a clinical service.`,
  },
  {
    id: "privacy",
    title: "6. Privacy — do not share personal information",
  ...
  {
    id: "illegal",
    title: "7. No scams, spam, illegal activities, prostitution or drugs",
    body: `Do not run investment, romance, or “send Pi to unlock” scams. Do not impersonate YouNeon, Pi Network, or another user. Do not spam matching or flood chat. Do not offer or solicit prostitution, escorting, or illegal drugs on YouNeon. Gifts and Premium are optional in-app purchases — never a fee for safety.`,
  },
  {
    id: "recording",
    title: "8. No recording or capturing without consent",
  ...
  {
    id: "false-reports",
    title: "9. False reports are prohibited",
