(function youneonPiBoot() {
  ...
  var CTRL_STYLE =
    "height:56px;padding:0 22px;font-size:16px;font-weight:700;line-height:1;border:0;border-radius:18px;color:#ffffff;background-color:#C21875;background-image:linear-gradient(180deg,#c084fc 0%,#a855f7 46%,#C21875 100%);cursor:pointer;width:100%;max-width:100%;display:flex;align-items:center;justify-content:center;gap:10px;box-sizing:border-box;font-family:system-ui,-apple-system,Segoe UI,sans-serif;pointer-events:auto;position:relative;z-index:2147483647;touch-action:manipulation;-webkit-tap-highlight-color:rgba(168,85,247,0.35);user-select:none;-webkit-user-select:none;caret-color:transparent;box-shadow:0 14px 28px rgba(168,85,247,0.4),0 1px 0 rgba(255,255,255,0.28) inset";
  var STATUS_STYLE =
    "font-size:0.75rem;color:#a78bfa;margin:12px 0 0;max-width:320px;pointer-events:none;user-select:none;line-height:1.45;word-break:break-word;font-family:system-ui,-apple-system,Segoe UI,sans-serif";
  var NATIVE_ATTRS =
  ...
  var CONTROLS_HTML =
    '<button type="button" class="youneon-signin-btn" data-youneon-signin="1" style="' + CTRL_STYLE + '" ' + NATIVE_ATTRS + '><svg width="22" height="22" viewBox="0 0 22 22" aria-hidden="true" style="display:block;flex-shrink:0;pointer-events:none"><circle cx="11" cy="11" r="11" fill="#F6C344"/><path d="M11 2.15A8.85 8.85 0 0 1 19.85 11H11V2.15Z" fill="#1a1028"/></svg>Sign in with Pi Network</button>';
  var STATUS_HTML =
